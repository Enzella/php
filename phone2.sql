...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 17, 2023 lúc 05:03 PM
...
(3, 21, 'Màu Trắng', 100, 50, '2023-10-31', '2023-11-14', '2023-10-31 08:52:33', '2023-10-31 08:52:33');
...
(2, 10, 1, 5, 'Hợp ví tiền.', '2023-10-31 09:01:23', '2023-10-31 09:01:23'),
...
(1, 1, 'Ưu đãi giảm giá 10% cho Xiaomi Redmi 12. Mua ngay!', '2023-10-31', '2023-11-14', '2023-10-31 10:53:52', '2023-10-31 10:53:52'),
(2, 1, 'Quà tặng kèm khi mua Xiaomi Redmi 12 trong tháng này.', '2023-10-31', '2023-11-14', '2023-10-31 10:53:52', '2023-10-31 10:53:52'),
(3, 1, 'Mua Xiaomi Redmi 12 giảm giá 20% trong ngày Black Friday.', '2023-11-22', '2023-11-24', '2023-10-31 10:53:52', '2023-10-31 10:53:52');
...
INSERT INTO `user` (`id`, `name`, `username`, `password`, `ngaysinh`, `gioitinh`, `email`, `phone`, `address`, `avatar_image`, `create_at`, `update_at`, `admin`) VALUES
(1, 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', '2023-11-17', 'true', 'admin@gmail.com', 911111111, 'Cà mau', '', '2023-11-16 18:07:13', '2023-11-16 18:07:13', 0);
...
--
-- Các ràng buộc cho bảng `advertises`
--
ALTER TABLE `advertises`
...
--
ALTER TABLE `notices`
  ADD CONSTRAINT `notices_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
...
--
ALTER TABLE `product_votes`
  ADD CONSTRAINT `product_votes_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `product_votes_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`);
