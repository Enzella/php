...
function init_quickOrder() {
    ...
    $(".control #btnMinutes").click(function() {
        ...
        return n = n > 1 ? n - 1 : n,
            ...
            i = t * n,
            $("#quickOrderPriceLast").text((new Intl.NumberFormat).format(i)), !1
    });
...
! function(n, t) {
    ...
    function ni(n, t, r) {
        ...
        return (r = r || ci(n)) && ("" !== (f = r.getPropertyValue(t) || r[t]) || st(n) || (f = i.style(n, t)), !e.pixelBoxStyles() && nr.test(f) && to.test(t) && (o = u.width,
                s = u.minWidth,
                h = u.maxWidth,
                ...
                for (p = (t = (t || "").match(l) || [""]).length; p--;)
                    if (o = d = (c = yu.exec(t[p]) || [])[1],
                        ...
                        for (h = i.event.special[o] || {},
                            ...
                            k = y = a.length; y--;)
                            s = a[y], !e && d !== s.origType || u && u.guid !== s.guid || c && !c.test(s.namespace) || f && f !== s.selector && ("**" !== f || !s.selector) || (a.splice(y, 1),
                        ...
                        f && (p = function(n, t, i) {
                            ...
                            if (f)
                                return f !== r[0] && r.unshift(f),
                                    i[f]
                        }(u, e, f)), !v && -1 < i.inArray("script", u.dataTypes) && (u.converters["text script"] = function() {}),
                        p = function(n, t, i, r) {
                            var h, u, f, s, e, o = {},
                                c = n.dataTypes.slice();
                            if (c[1])
                ...
                for (g in (y = i.event && u.global) && 0 == i.active++ && i.event.trigger("ajaxStart"),
                    ...
                    u.hasContent ? u.data && u.processData && 0 === (u.contentType || "").indexOf("application/x-www-form-urlencoded") && (u.data = u.data.replace(oo, "+")) : (p = u.url.slice(o.length),
                        u.data && (u.processData || "string" == typeof u.data) && (o += (or.test(o) ? "&" : "?") + u.data,
                            delete u.data), !1 === u.cache && (o = o.replace(ho, "$1"),
    ...
    n.ScrollToFixed = function(t, i) {
        ...
        var p = !1,
            ...
            lt = function() {
                var n = document.body,
                    t, i, r, u, f;
                return document.createElement && n && n.appendChild && n.removeChild ? (t = document.createElement("div"), !t.getBoundingClientRect) ? null : (t.innerHTML = "x",
        ...
        i.extend(h.prototype, {
            ...
            jumpTo: function(n, t) {
                ...
                if (!(r.isDragging || r.isClosing || r.isAnimating && r.firstRun)) {
                    if (n = parseInt(n, 10), !(h = r.current ? r.current.opts.loop : r.opts.loop) && (n < 0 || n >= l))
                        return !1;
            ...
            createSlide: function(n) {
                ...
                return r = n % t.group.length,
                    r = r < 0 ? t.group.length + r : r, !t.slides[n] && t.group[r] && (u = i('<div class="fancybox-slide"><\/div>').appendTo(t.$refs.stage),
            ...
            isMoved: function(n) {
                ...
                return !!u && (r = i.fancybox.getTranslate(this.$refs.stage),
                    t = i.fancybox.getTranslate(u.$slide), !u.$slide.hasClass("fancybox-animated") && (Math.abs(t.top - r.top) > .5 || Math.abs(t.left - r.left) > .5))
            },
            ...
            loadSlide: function(n) {
                ...
                if (!n.isLoading && !n.isLoaded) {
                    if (n.isLoading = !0, !1 === t.trigger("beforeLoad", n))
            ...
            afterLoad: function(n) {
                ...
                t.isClosing || (n.isLoading = !1,
                    ...
                    t.hideLoading(n), !n.opts.smallBtn || n.$smallBtn && n.$smallBtn.length || (n.$smallBtn = i(t.translate(n, n.opts.btnTpl.smallBtn)).appendTo(n.$content)),
            ...
            revealContent: function(n) {
                ...
                return n.isRevealed = !0,
                    ...
                    f = parseInt(void 0 === n.forcedDuration ? f : n.forcedDuration, 10), !l && n.pos === t.currPos && f || (r = !1),
            ...
            close: function(n, t) {
                ...
                return !r.isClosing && (r.isClosing = !0, !1 === r.trigger("beforeClose", n) ? (r.isClosing = !1,
                    c(function() {
                        r.update()
                    }), !1) : (r.removeEvents(),
                    h = f.$content,
                    ...
                    f.$slide.removeClass("fancybox-slide--complete fancybox-slide--next fancybox-slide--previous fancybox-animated"), !0 !== n ? i.fancybox.stop(f.$slide) : o = !1,
                    ...
                    "zoom" === o ? (i.fancybox.stop(h),
                        ...
                        u(h),
                        i.fancybox.animate(h, e, s, v), !0) : (o && s ? i.fancybox.animate(f.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + o, s, v) : !0 === n ? setTimeout(v, s) : v(), !0)))
            },
            cleanUp: function(t) {
                var f, e, o, r = this,
            ...
            trigger: function(n, t) {
                ...
                if (u ? f.unshift(u) : u = e,
                    f.unshift(e),
                    i.isFunction(u.opts[n]) && (o = u.opts[n].apply(u, f)), !1 === o)
                    return o;
    ...
    var o = function() {
        ...
        h = function(n) {
            for (var t = !1;;) {
                if (t = c(n.get(0)))
                    break;
                if (n = n.parent(), !n.length || n.hasClass("fancybox-stage") || n.is("body"))
                    break
            }
            return t
        },
    ...
    t.extend(r.prototype, {
        ...
        init: function(n) {
            ...
            for (t.instance = n,
                ...
                i = 0,
                f = r.length; i < f && (r[i].thumb && u++, !(u > 1)); i++)
            ;
        ...
        i.prototype = {
            ...
            suggest: function() {
                ...
                var t = this,
                    ...
                    p = t.classes.selected,
                    e = n(t.suggestionsContainer),
                    w = n(t.noSuggestionsContainer),
                    c = f.beforeRender,
                    i = "",
                    l = f.showLink,
                    o, b = function(n) {
